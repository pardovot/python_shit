...
def get_article_talkbacks(url):
    ...
    for comment in all_comments:
        ...
        text = driver.execute_script('return arguments[0].querySelector(".spcv_message-entities").innerText', comment)
        try:
            likes = driver.execute_script('return arguments[0].querySelectorAll(".spcv_likes-count")[0].innerText', comment)
        except:
            pass
            
        try:
            dislikes = driver.execute_script('return arguments[0].querySelectorAll(".spcv_likes-count")[1].innerText', comment)
        except:
            pass
